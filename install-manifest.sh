...
sed -i -e "s%\$EXT_ID%resistance-advisor@extension.js%" ./native-messaging-manifest.firefox.json
...
mkdir -p /usr/lib/librewolf/native-messaging-hosts

cp ./native-messaging-manifest.firefox.json /usr/lib/mozilla/native-messaging-hosts/$MANIFEST_NAME
cp ./native-messaging-manifest.firefox.json /usr/lib/librewolf/native-messaging-hosts/$MANIFEST_NAME
